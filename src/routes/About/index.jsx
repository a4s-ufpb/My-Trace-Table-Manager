  ...
  return (
    <div className={styles.aboutContainer}>
      <div className={styles.aboutSection}>
        <img src={imgAyla} alt="Diego Tavares" className={styles.aboutImage} />
        <p>
      ...
      <div className={styles.aboutSection}>
        <img src={imgAnna} alt="Ayla Dantas" className={styles.aboutImage} />
        <p>
      ...
      <div className={styles.aboutSection}>
        <img src={imgElk} alt="Ronyelison Abreu" className={styles.aboutImage} />
        <p>
